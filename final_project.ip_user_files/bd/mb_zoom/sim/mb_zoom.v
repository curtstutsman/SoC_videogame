...
(* CORE_GENERATION_INFO = "mb_zoom,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=mb_zoom,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=29,numReposBlks=18,numNonXlnxBlks=0,numHierBlks=11,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=8,da_board_cnt=9,da_clkrst_cnt=1,da_mb_cnt=2,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "mb_zoom.hwdef" *) 
module mb_zoom
   (clk_100MHz,
    gpio_usb_int_tri_i,
    gpio_usb_keycode_0,
  ...
  (* KEEP_HIERARCHY = "yes" *) 
  mb_zoom_microblaze_0_1 microblaze_0
...
module microblaze_0_local_memory_imp_1X2JT36
  ...
  (* KEEP_HIERARCHY = "yes" *) 
  mb_zoom_dlmb_bram_if_cntlr_1 dlmb_bram_if_cntlr
  ...
  mb_zoom_dlmb_v10_1 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  mb_zoom_ilmb_bram_if_cntlr_1 ilmb_bram_if_cntlr

...
#
# Generated by export_simulation on Wed Dec 13 14:10:40 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './bgselect_rom.sh' script.

./bgselect_rom.sh -reset_run
...
./bgselect_rom.sh -noclean_files

For more information on the script, please type './bgselect_rom.sh -help'.

...
#
# Generated by Vivado on Mon Dec 04 00:33:30 -0600 2023
...
simulate()
{
  xsim  blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_zoom.protoinst" -log simulate.log
}

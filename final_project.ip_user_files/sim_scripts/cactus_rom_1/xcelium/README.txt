...
#
# Generated by export_simulation on Thu Dec 07 22:20:03 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './cactus_rom.sh' script.

./cactus_rom.sh -reset_run
...
./cactus_rom.sh -noclean_files

For more information on the script, please type './cactus_rom.sh -help'.

...
#
# Generated by export_simulation on Sat Dec 02 02:22:35 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './city_backdrop_rom.sh' script.

./city_backdrop_rom.sh -reset_run
...
./city_backdrop_rom.sh -noclean_files

For more information on the script, please type './city_backdrop_rom.sh -help'.

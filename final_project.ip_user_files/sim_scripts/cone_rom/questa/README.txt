...
#
# Generated by export_simulation on Tue Nov 28 17:15:45 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './cone_rom.sh' script.

./cone_rom.sh -reset_run
...
./cone_rom.sh -noclean_files

For more information on the script, please type './cone_rom.sh -help'.

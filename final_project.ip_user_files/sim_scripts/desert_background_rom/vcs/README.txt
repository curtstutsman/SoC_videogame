...
#
# Generated by export_simulation on Wed Dec 13 13:37:43 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './desert_background_rom.sh' script.

./desert_background_rom.sh -reset_run
...
./desert_background_rom.sh -noclean_files

For more information on the script, please type './desert_background_rom.sh -help'.

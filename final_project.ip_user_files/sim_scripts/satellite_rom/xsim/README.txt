...
#
# Generated by export_simulation on Thu Dec 07 20:56:52 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './satellite_rom.sh' script.

./satellite_rom.sh -reset_run
...
./satellite_rom.sh -noclean_files

For more information on the script, please type './satellite_rom.sh -help'.

...
#
# Generated by export_simulation on Wed Nov 22 15:02:44 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './trashcan_rom.sh' script.

./trashcan_rom.sh -reset_run
...
./trashcan_rom.sh -noclean_files

For more information on the script, please type './trashcan_rom.sh -help'.

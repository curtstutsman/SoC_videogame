...
#
# Generated by export_simulation on Thu Dec 07 16:53:29 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './tree_rom.sh' script.

./tree_rom.sh -reset_run
...
./tree_rom.sh -noclean_files

For more information on the script, please type './tree_rom.sh -help'.

...
HD_PWD='C:/Users/stuts/PersonalCode/ece385/final_project/final_project.runs/bgselect_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bgselect_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bgselect_rom.tcl

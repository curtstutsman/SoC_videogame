...
HD_PWD='C:/Users/stuts/PersonalCode/ece385/final_project/final_project.runs/city_backdrop_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log city_backdrop_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source city_backdrop_rom.tcl

...
HD_PWD='C:/Users/stuts/PersonalCode/ece385/final_project/final_project.runs/desert_background_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log desert_background_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source desert_background_rom.tcl

...
HD_PWD='C:/Users/stuts/PersonalCode/ece385/final_project/final_project.runs/explosion1_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log explosion1_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source explosion1_rom.tcl

...
HD_PWD='C:/Users/stuts/PersonalCode/ece385/final_project/final_project.runs/explosion7_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log explosion7_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source explosion7_rom.tcl

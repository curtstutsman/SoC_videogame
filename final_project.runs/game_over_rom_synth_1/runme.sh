...
HD_PWD='C:/Users/stuts/PersonalCode/ece385/final_project/final_project.runs/game_over_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_over_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_over_rom.tcl

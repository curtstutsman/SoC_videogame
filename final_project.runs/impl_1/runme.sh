...
HD_PWD='C:/Users/stuts/PersonalCode/ece385/final_project/final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zoom_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zoom_top.tcl -notrace

...
HD_PWD='C:/Users/stuts/PersonalCode/ece385/final_project/final_project.runs/main_menu_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_menu_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_menu_rom.tcl

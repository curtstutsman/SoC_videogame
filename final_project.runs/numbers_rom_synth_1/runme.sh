...
HD_PWD='C:/Users/stuts/PersonalCode/ece385/final_project/final_project.runs/numbers_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log numbers_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source numbers_rom.tcl

...
HD_PWD='C:/Users/stuts/PersonalCode/ece385/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zoom_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zoom_top.tcl

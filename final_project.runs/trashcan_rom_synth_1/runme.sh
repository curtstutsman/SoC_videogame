...
HD_PWD='C:/Users/stuts/PersonalCode/ece385/final_project/final_project.runs/trashcan_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trashcan_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trashcan_rom.tcl

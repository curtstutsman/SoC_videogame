...
HD_PWD='C:/Users/stuts/PersonalCode/ece385/final_project/final_project.runs/yellow_car_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log yellow_car_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source yellow_car_rom.tcl
